...
Upplägget är helt mobilt, vi kommer till er i hela Sverige. Man spelar på gräs, konstgräs eller inomhus.[/vc_column_text][vc_icon icon_fontawesome="fa fa-arrow-right" color="custom"][/vc_column][vc_column width="1/3"][heading2 title="Upplev BubbleBall"][vc_column_text]<strong>Hur kul vill ni ha??</strong>
...
Upplägget är helt mobilt, vi kommer till er med bollar och annan utrustning. Vi spelar på gräs, konstgräs eller inomhus.[/vc_column_text][button color="theme" href="http://stockholmcoder.com/om-bubble-ball/detta-ar-bubble-ball/"]Läs mer[/button][/vc_column][vc_column width="1/3"][heading2 title="Vi kan det här!"][vc_column_text]
<ul>
